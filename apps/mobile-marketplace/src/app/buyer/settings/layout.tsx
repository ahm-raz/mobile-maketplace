...
export default function BuyerSettingsLayout({ children }: { children: React.ReactNode }) {
	return (
		<div container-id="buyer-settings-layout" className="flex flex-col gap-8">
			<BuyerDashboardNav />
			<div className="flex flex-col gap-8 lg:grid lg:grid-cols-[200px_minmax(0,1fr)] lg:items-start lg:gap-12">
				<nav
					aria-label="Settings"
